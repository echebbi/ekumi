...
import fr.kazejiyu.ekumi.specs.eds.design.TaskServices;
...
public class TaskServicesTest implements WithAssertions {
	...
	void can_delete_a_successor_predecessor_relationship_from_an_edge() {
		...
		Node sourceNode = EdsFactory.eINSTANCE.createActivity();
		Node targetNode = EdsFactory.eINSTANCE.createActivity();
		Node anotherSuccessor = EdsFactory.eINSTANCE.createActivity();
	...
	void can_add_an_input_to_a_task() {
		Task task = EdsFactory.eINSTANCE.createExternalTask();
