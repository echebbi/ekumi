...
/**
 * This is the action bar contributor for the Spec model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SpecActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
	/**
	 ...
	 * @generated
	 */
	public SpecActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("spec-settings"));
		toolBarManager.add(new Separator("spec-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(EKumiEditorPlugin.INSTANCE.getString("_UI_SpecEditor_menu"),
				"fr.kazejiyu.ekumi.model.specMenuID");
