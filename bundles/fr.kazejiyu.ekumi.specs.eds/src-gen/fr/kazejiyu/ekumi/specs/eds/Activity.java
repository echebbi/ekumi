 ...
 * <!-- end-user-doc -->
 *
 * @see fr.kazejiyu.ekumi.specs.eds.EdsPackage#getActivity()
 * @model
 * @generated
 */
public interface Activity extends Task {
	 ...
	 * @see #setStart(Start)
	 * @see fr.kazejiyu.ekumi.specs.eds.SpecPackage#getActivity_Start()
	 * <!-- end-user-doc -->
	...
	/**
	 * <!-- begin-user-doc -->
	 * Sets the value of the '{@link fr.kazejiyu.ekumi.specs.eds.Activity#getStart <em>Start</em>}' containment reference.
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link fr.kazejiyu.ekumi.specs.eds.Activity}.
	 * It is bidirectional and its opposite is '{@link fr.kazejiyu.ekumi.specs.eds.Activity#getParentActivity <em>Parent Activity</em>}'.
	 * @return the value of the '<em>Nested Activities</em>' containment reference list.
	 * @see fr.kazejiyu.ekumi.specs.eds.SpecPackage#getActivity_NestedActivities()
	 ...
	 * It is bidirectional and its opposite is '{@link fr.kazejiyu.ekumi.specs.eds.Activity#getNestedActivities <em>Nested Activities</em>}'.
	 * @return the value of the '<em>Parent Activity</em>' container reference.
	 * @see #setParentActivity(Activity)
	 * @see fr.kazejiyu.ekumi.specs.eds.SpecPackage#getActivity_ParentActivity()
	...
	/**
	 * <!-- begin-user-doc -->
	 * Sets the value of the '{@link fr.kazejiyu.ekumi.specs.eds.Activity#getParentActivity <em>Parent Activity</em>}' container reference.
	 * <!-- end-user-doc -->
	 ...
	 * @see fr.kazejiyu.ekumi.specs.eds.SpecPackage#getActivity_Tasks()
	 * <!-- end-user-doc -->
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * The list contents are of type {@link fr.kazejiyu.ekumi.specs.eds.Divergence}.
	 * @return the value of the '<em>Divergences</em>' containment reference list.
	 * @see fr.kazejiyu.ekumi.specs.eds.SpecPackage#getActivity_Divergences()
	 * <!-- end-user-doc -->
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * The list contents are of type {@link fr.kazejiyu.ekumi.specs.eds.Convergence}.
	 * @return the value of the '<em>Convergences</em>' containment reference list.
	 * @see fr.kazejiyu.ekumi.specs.eds.SpecPackage#getActivity_Convergences()
	 * <!-- end-user-doc -->
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * The list contents are of type {@link fr.kazejiyu.ekumi.specs.eds.ConditionalDivergence}.
	 * @return the value of the '<em>Conditional Divergences</em>' containment reference list.
	 * @see fr.kazejiyu.ekumi.specs.eds.SpecPackage#getActivity_ConditionalDivergences()
	 * <!-- end-user-doc -->
	 * @model containment="true"
	 * @generated
	 */
