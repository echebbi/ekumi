...
import fr.kazejiyu.ekumi.specs.eds.LibraryTask;
 ...
 * @generated
 */
public class EdsPackageImpl extends EPackageImpl implements EdsPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see fr.kazejiyu.ekumi.specs.eds.EdsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private EdsPackageImpl() {
		super(eNS_URI, EdsFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link EdsPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static EdsPackage init() {
		if (isInited)
			return (EdsPackage) EPackage.Registry.INSTANCE.getEPackage(EdsPackage.eNS_URI);

		// Obtain or create and register package
		EdsPackageImpl theEdsPackage = (EdsPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof EdsPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
						: new EdsPackageImpl());
		...
		theEdsPackage.createPackageContents();

		// Initialize created meta-data
		theEdsPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theEdsPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(EdsPackage.eNS_URI, theEdsPackage);
		return theEdsPackage;
	}
	 ...
	 * @generated
	 */
	public EdsFactory getEdsFactory() {
		return (EdsFactory) getEFactoryInstance();
	}
