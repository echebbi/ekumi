...
public class SpecSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case SpecPackage.JOIN_BEHAVIOR: {
			JoinBehavior joinBehavior = (JoinBehavior) theEObject;
			T result = caseJoinBehavior(joinBehavior);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case SpecPackage.START_JOIN: {
			...
			if (result == null)
				result = caseJoinBehavior(startJoin);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case SpecPackage.SPLIT_JOIN: {
			...
			if (result == null)
				result = caseJoinBehavior(splitJoin);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case SpecPackage.SIMPLE_JOIN: {
			...
			if (result == null)
				result = caseJoinBehavior(simpleJoin);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case SpecPackage.REPEAT_JOIN: {
			...
			if (result == null)
				result = caseJoinBehavior(repeatJoin);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Join Behavior</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Join Behavior</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseJoinBehavior(JoinBehavior object) {
		return null;
	}
