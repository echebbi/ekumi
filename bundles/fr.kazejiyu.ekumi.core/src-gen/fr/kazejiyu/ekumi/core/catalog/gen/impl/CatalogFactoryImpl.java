...
public class CatalogFactoryImpl extends EFactoryImpl implements CatalogFactory {
	 ...
	 * @generated
	 */
	public fr.kazejiyu.ekumi.core.workflow.Activity createActivityFromString(EDataType eDataType, String initialValue) {
		return (fr.kazejiyu.ekumi.core.workflow.Activity) super.createFromString(eDataType, initialValue);
	}
