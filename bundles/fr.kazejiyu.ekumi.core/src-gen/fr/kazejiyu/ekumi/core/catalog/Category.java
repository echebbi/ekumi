 ...
 * <!-- end-user-doc -->
 *
 * @see fr.kazejiyu.ekumi.core.catalog.CatalogPackage#getCategory()
 * @model
 * @generated
 */
public interface Category extends Group {
	 ...
	 * The list contents are of type {@link fr.kazejiyu.ekumi.core.catalog.ActivityTemplate}.
	 * It is bidirectional and its opposite is '{@link fr.kazejiyu.ekumi.core.catalog.ActivityTemplate#getCategory <em>Category</em>}'.
	 * @return the value of the '<em>Activity Templates</em>' containment reference list.
	 * @see fr.kazejiyu.ekumi.core.catalog.CatalogPackage#getCategory_ActivityTemplates()
