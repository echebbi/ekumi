 ...
 * </p>
 * <ul>
 *   <li>{@link fr.kazejiyu.ekumi.core.ekumi.impl.UnsafeContextImpl#getVariables <em>Variables</em>}</li>
 *   <li>{@link fr.kazejiyu.ekumi.core.ekumi.impl.UnsafeContextImpl#getExecution <em>Execution</em>}</li>
 *   <li>{@link fr.kazejiyu.ekumi.core.ekumi.impl.UnsafeContextImpl#getEvents <em>Events</em>}</li>
 *   <li>{@link fr.kazejiyu.ekumi.core.ekumi.impl.UnsafeContextImpl#getExecutionStatus <em>Execution Status</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UnsafeContextImpl extends MinimalEObjectImpl.Container implements UnsafeContext {
	...
	protected EClass eStaticClass() {
		return EkumiPackage.Literals.UNSAFE_CONTEXT;
	}
	...
	public EList<Variable> getVariables() {
		if (variables == null) {
			variables = new EObjectContainmentEList<Variable>(Variable.class, this,
					EkumiPackage.UNSAFE_CONTEXT__VARIABLES);
		}
		return variables;
	}
	...
	public void setExecution(Execution newExecution) {
		if (newExecution != eInternalContainer()
			...
			eNotify(new ENotificationImpl(this, Notification.SET, EkumiPackage.UNSAFE_CONTEXT__EXECUTION, newExecution,
					newExecution));
	}
	...
	public void setEvents(Events newEvents) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EkumiPackage.UNSAFE_CONTEXT__EVENTS, oldEvents,
					events));
	}
	...
	public void setExecutionStatus(ExecutionStatus newExecutionStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EkumiPackage.UNSAFE_CONTEXT__EXECUTION_STATUS,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case EkumiPackage.UNSAFE_CONTEXT___SAFE:
			return safe();
		}
