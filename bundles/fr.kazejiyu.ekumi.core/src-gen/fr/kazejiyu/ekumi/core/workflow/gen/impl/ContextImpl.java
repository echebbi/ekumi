 ...
 * </p>
 * <ul>
 *   <li>{@link fr.kazejiyu.ekumi.core.workflow.gen.impl.ContextImpl#getVariables <em>Variables</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContextImpl extends MinimalEObjectImpl.Container implements Context {
	...
	protected EClass eStaticClass() {
		return WorkflowPackage.Literals.CONTEXT;
	}
	...
	public EList<Variable> getVariables() {
		if (variables == null) {
			variables = new EObjectResolvingEList<Variable>(Variable.class, this, WorkflowPackage.CONTEXT__VARIABLES);
		}
		return variables;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case WorkflowPackage.CONTEXT__VARIABLES:
			return getVariables();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case WorkflowPackage.CONTEXT___EVENTS:
			return events();
		case WorkflowPackage.CONTEXT___EXECUTION:
			return execution();
		...
		case WorkflowPackage.CONTEXT___SET__STRING_OBJECT:
			...
			return null;
		case WorkflowPackage.CONTEXT___UNSET__STRING:
