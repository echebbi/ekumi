 ...
 * </p>
 * <ul>
 *   <li>{@link fr.kazejiyu.ekumi.core.workflow.gen.impl.StructuredLoopImpl#getPreCondition <em>Pre Condition</em>}</li>
 *   <li>{@link fr.kazejiyu.ekumi.core.workflow.gen.impl.StructuredLoopImpl#getPostCondition <em>Post Condition</em>}</li>
 *   <li>{@link fr.kazejiyu.ekumi.core.workflow.gen.impl.StructuredLoopImpl#getActivity <em>Activity</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StructuredLoopImpl extends ActivityImpl implements StructuredLoop {
	...
	protected EClass eStaticClass() {
		return WorkflowPackage.Literals.STRUCTURED_LOOP;
	}
	...
	public NotificationChain basicSetPreCondition(Condition newPreCondition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					WorkflowPackage.STRUCTURED_LOOP__PRE_CONDITION, oldPreCondition, newPreCondition);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newPreCondition != preCondition) {
			...
			if (preCondition != null)
				msgs = ((InternalEObject) preCondition).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - WorkflowPackage.STRUCTURED_LOOP__PRE_CONDITION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, WorkflowPackage.STRUCTURED_LOOP__PRE_CONDITION,
	...
	public NotificationChain basicSetPostCondition(Condition newPostCondition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					WorkflowPackage.STRUCTURED_LOOP__POST_CONDITION, oldPostCondition, newPostCondition);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newPostCondition != postCondition) {
			...
			if (postCondition != null)
				msgs = ((InternalEObject) postCondition).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - WorkflowPackage.STRUCTURED_LOOP__POST_CONDITION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, WorkflowPackage.STRUCTURED_LOOP__POST_CONDITION,
	...
	public NotificationChain basicSetActivity(Activity newActivity, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					WorkflowPackage.STRUCTURED_LOOP__ACTIVITY, oldActivity, newActivity);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newActivity != activity) {
			...
			if (activity != null)
				msgs = ((InternalEObject) activity).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - WorkflowPackage.STRUCTURED_LOOP__ACTIVITY, null, msgs);
			if (newActivity != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, WorkflowPackage.STRUCTURED_LOOP__ACTIVITY,
