 ...
 * <!-- end-user-doc -->
 *
 * @see fr.kazejiyu.ekumi.core.workflow.WorkflowPackage#getHistory()
 * @model
 * @generated
 */
public interface History extends EObject {
	 ...
	 * The list contents are of type {@link fr.kazejiyu.ekumi.core.workflow.Execution}.
	 * @return the value of the '<em>Executions</em>' containment reference list.
	 * @see fr.kazejiyu.ekumi.core.workflow.WorkflowPackage#getHistory_Executions()
	 * <!-- end-user-doc -->
