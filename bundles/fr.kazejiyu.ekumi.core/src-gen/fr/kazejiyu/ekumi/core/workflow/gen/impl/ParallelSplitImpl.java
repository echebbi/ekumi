 ...
 * </p>
 * <ul>
 *   <li>{@link fr.kazejiyu.ekumi.core.workflow.gen.impl.ParallelSplitImpl#getBranches <em>Branches</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParallelSplitImpl extends ActivityImpl implements ParallelSplit {
	...
	protected EClass eStaticClass() {
		return WorkflowPackage.Literals.PARALLEL_SPLIT;
	}
	...
	public EList<Activity> getBranches() {
		if (branches == null) {
			branches = new EObjectContainmentEList<Activity>(Activity.class, this,
					WorkflowPackage.PARALLEL_SPLIT__BRANCHES);
		}
		return branches;
	}
