...
/**
 * This is the item provider adapter for a {@link fr.kazejiyu.ekumi.model.workflow.UnsafeContext} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UnsafeContextItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addVariablesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						WorkflowPackage.Literals.UNSAFE_CONTEXT__VARIABLES, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_UnsafeContext_execution_feature",
								"_UI_UnsafeContext_type"),
						WorkflowPackage.Literals.UNSAFE_CONTEXT__EXECUTION, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_UnsafeContext_events_feature",
								"_UI_UnsafeContext_type"),
						WorkflowPackage.Literals.UNSAFE_CONTEXT__EVENTS, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_UnsafeContext_executionStatus_feature",
								"_UI_UnsafeContext_type"),
						WorkflowPackage.Literals.UNSAFE_CONTEXT__EXECUTION_STATUS, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WorkflowPackage.Literals.UNSAFE_CONTEXT__VARIABLES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(WorkflowPackage.Literals.UNSAFE_CONTEXT__VARIABLES,
