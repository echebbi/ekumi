...
/**
 * This is the item provider adapter for a {@link fr.kazejiyu.ekumi.model.workflow.Execution} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExecutionItemProvider extends IdentifiableItemProvider {
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Execution_activity_feature",
								"_UI_Execution_type"),
						WorkflowPackage.Literals.EXECUTION__ACTIVITY, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Execution_context_feature",
								"_UI_Execution_type"),
						WorkflowPackage.Literals.EXECUTION__CONTEXT, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Execution_startDate_feature",
								"_UI_Execution_type"),
						WorkflowPackage.Literals.EXECUTION__START_DATE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WorkflowPackage.Literals.EXECUTION__ACTIVITY);
			childrenFeatures.add(WorkflowPackage.Literals.EXECUTION__CONTEXT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(WorkflowPackage.Literals.EXECUTION__ACTIVITY,
		...
		newChildDescriptors.add(createChildParameter(WorkflowPackage.Literals.EXECUTION__CONTEXT,
				WorkflowFactory.eINSTANCE.createUnsafeContext()));
	}
