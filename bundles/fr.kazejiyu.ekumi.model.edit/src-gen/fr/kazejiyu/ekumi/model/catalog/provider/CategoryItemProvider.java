...
public class CategoryItemProvider extends GroupItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CatalogPackage.Literals.CATEGORY__ACTIVITY_TEMPLATES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(CatalogPackage.Literals.CATEGORY__ACTIVITY_TEMPLATES,
				CatalogFactory.eINSTANCE.createActivityTemplate()));
	}
