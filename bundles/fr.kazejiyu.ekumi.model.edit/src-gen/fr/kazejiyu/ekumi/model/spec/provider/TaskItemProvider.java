...
/**
 * This is the item provider adapter for a {@link fr.kazejiyu.ekumi.model.spec.Task} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TaskItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Task_id_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Task_id_feature", "_UI_Task_type"),
						SpecPackage.Literals.TASK__ID, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
						null, null));
	}
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						SpecPackage.Literals.TASK__NAME, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
						null, null));
	}
	...
	protected void addSuccessorPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Task_successor_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Task_successor_feature", "_UI_Task_type"),
						SpecPackage.Literals.TASK__SUCCESSOR, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SpecPackage.Literals.TASK__FLOWS);
			childrenFeatures.add(SpecPackage.Literals.TASK__INPUTS);
			childrenFeatures.add(SpecPackage.Literals.TASK__OUTPUTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(SpecPackage.Literals.TASK__FLOWS, SpecFactory.eINSTANCE.createDataFlows()));

		newChildDescriptors
				.add(createChildParameter(SpecPackage.Literals.TASK__INPUTS, SpecFactory.eINSTANCE.createVariable()));

		newChildDescriptors
				.add(createChildParameter(SpecPackage.Literals.TASK__OUTPUTS, SpecFactory.eINSTANCE.createVariable()));
	}
