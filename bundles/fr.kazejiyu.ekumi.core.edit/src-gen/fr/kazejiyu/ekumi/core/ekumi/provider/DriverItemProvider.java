...
/**
 * This is the item provider adapter for a {@link fr.kazejiyu.ekumi.core.ekumi.Driver} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DriverItemProvider extends ActivityItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EkumiPackage.Literals.DRIVER__DRIVEN);
			childrenFeatures.add(EkumiPackage.Literals.DRIVER__SCRIPT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(EkumiPackage.Literals.DRIVER__DRIVEN, EkumiFactory.eINSTANCE.createSequence()));

		newChildDescriptors.add(createChildParameter(EkumiPackage.Literals.DRIVER__DRIVEN,
		...
		newChildDescriptors.add(
				createChildParameter(EkumiPackage.Literals.DRIVER__DRIVEN, EkumiFactory.eINSTANCE.createMultiChoice()));

		newChildDescriptors
				.add(createChildParameter(EkumiPackage.Literals.DRIVER__DRIVEN, EkumiFactory.eINSTANCE.createDriver()));
