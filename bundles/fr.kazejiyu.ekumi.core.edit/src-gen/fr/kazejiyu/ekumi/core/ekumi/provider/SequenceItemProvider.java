...
/**
 * This is the item provider adapter for a {@link fr.kazejiyu.ekumi.core.ekumi.Sequence} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SequenceItemProvider extends ActivityItemProvider {
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Sequence_activities_feature",
								"_UI_Sequence_type"),
						EkumiPackage.Literals.SEQUENCE__ACTIVITIES, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EkumiPackage.Literals.SEQUENCE__ROOT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(EkumiPackage.Literals.SEQUENCE__ROOT, EkumiFactory.eINSTANCE.createSequence()));

		newChildDescriptors.add(createChildParameter(EkumiPackage.Literals.SEQUENCE__ROOT,
		...
		newChildDescriptors.add(
				createChildParameter(EkumiPackage.Literals.SEQUENCE__ROOT, EkumiFactory.eINSTANCE.createMultiChoice()));

		newChildDescriptors
				.add(createChildParameter(EkumiPackage.Literals.SEQUENCE__ROOT, EkumiFactory.eINSTANCE.createDriver()));
