...
/**
 * This is the item provider adapter for a {@link fr.kazejiyu.ekumi.core.ekumi.Branch} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BranchItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addActivityPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Branch_activity_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Branch_activity_feature",
								"_UI_Branch_type"),
						EkumiPackage.Literals.BRANCH__ACTIVITY, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EkumiPackage.Literals.BRANCH__AVAILABILITY);
			childrenFeatures.add(EkumiPackage.Literals.BRANCH__ACTIVITY);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(EkumiPackage.Literals.BRANCH__ACTIVITY, EkumiFactory.eINSTANCE.createSequence()));

		newChildDescriptors.add(createChildParameter(EkumiPackage.Literals.BRANCH__ACTIVITY,
		...
		newChildDescriptors.add(
				createChildParameter(EkumiPackage.Literals.BRANCH__ACTIVITY, EkumiFactory.eINSTANCE.createDriver()));
