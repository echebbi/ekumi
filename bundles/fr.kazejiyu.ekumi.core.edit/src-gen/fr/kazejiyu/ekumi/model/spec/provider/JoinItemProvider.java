...
public class JoinItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SpecPackage.Literals.JOIN__BEHAVIOR);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(SpecPackage.Literals.JOIN__BEHAVIOR, SpecFactory.eINSTANCE.createStartJoin()));

		newChildDescriptors.add(
				createChildParameter(SpecPackage.Literals.JOIN__BEHAVIOR, SpecFactory.eINSTANCE.createSplitJoin()));

		newChildDescriptors.add(
				createChildParameter(SpecPackage.Literals.JOIN__BEHAVIOR, SpecFactory.eINSTANCE.createSimpleJoin()));

		newChildDescriptors.add(
				createChildParameter(SpecPackage.Literals.JOIN__BEHAVIOR, SpecFactory.eINSTANCE.createRepeatJoin()));
	}
