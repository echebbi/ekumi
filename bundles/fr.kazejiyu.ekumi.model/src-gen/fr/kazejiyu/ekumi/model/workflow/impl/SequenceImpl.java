 ...
 * </p>
 * <ul>
 *   <li>{@link fr.kazejiyu.ekumi.model.workflow.impl.SequenceImpl#getRoot <em>Root</em>}</li>
 *   <li>{@link fr.kazejiyu.ekumi.model.workflow.impl.SequenceImpl#getActivities <em>Activities</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SequenceImpl extends ActivityImpl implements Sequence {
	...
	protected EClass eStaticClass() {
		return WorkflowPackage.Literals.SEQUENCE;
	}
	...
	public NotificationChain basicSetRoot(Activity newRoot, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					WorkflowPackage.SEQUENCE__ROOT, oldRoot, newRoot);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newRoot != root) {
			...
			if (root != null)
				msgs = ((InternalEObject) root).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - WorkflowPackage.SEQUENCE__ROOT, null, msgs);
			if (newRoot != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, WorkflowPackage.SEQUENCE__ROOT, newRoot, newRoot));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case WorkflowPackage.SEQUENCE__ROOT:
			return getRoot();
		case WorkflowPackage.SEQUENCE__ACTIVITIES:
