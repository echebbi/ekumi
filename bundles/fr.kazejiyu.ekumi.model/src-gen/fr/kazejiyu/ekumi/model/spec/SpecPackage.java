...
public interface SpecPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int START_JOIN__ACTIVITIES = JOIN__ACTIVITIES;
	 ...
	 * @ordered
	 */
	int START_JOIN_FEATURE_COUNT = JOIN_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int START_JOIN_OPERATION_COUNT = JOIN_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int SPLIT_JOIN__ACTIVITIES = JOIN__ACTIVITIES;
	 ...
	 * @ordered
	 */
	int SPLIT_JOIN_FEATURE_COUNT = JOIN_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int SPLIT_JOIN_OPERATION_COUNT = JOIN_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int SIMPLE_JOIN__ACTIVITIES = JOIN__ACTIVITIES;
	 ...
	 * @ordered
	 */
	int SIMPLE_JOIN_FEATURE_COUNT = JOIN_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int SIMPLE_JOIN_OPERATION_COUNT = JOIN_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int REPEAT_JOIN__ACTIVITIES = JOIN__ACTIVITIES;
	 ...
	 * @ordered
	 */
	int REPEAT_JOIN_FEATURE_COUNT = JOIN_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int REPEAT_JOIN_OPERATION_COUNT = JOIN_OPERATION_COUNT + 0;
