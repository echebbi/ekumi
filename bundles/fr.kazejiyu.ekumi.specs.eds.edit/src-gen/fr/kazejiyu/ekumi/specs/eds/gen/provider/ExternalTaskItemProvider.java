...
/**
 * This is the item provider adapter for a {@link fr.kazejiyu.ekumi.specs.eds.ExternalTask} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExternalTaskItemProvider extends TaskItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ExternalTaskItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This adds a property descriptor for the Language Id feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addLanguageIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ExternalTask_languageId_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ExternalTask_languageId_feature",
								"_UI_ExternalTask_type"),
						EdsPackage.Literals.EXTERNAL_TASK__LANGUAGE_ID, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_ExternalTask_scriptId_feature",
								"_UI_ExternalTask_type"),
						EdsPackage.Literals.EXTERNAL_TASK__SCRIPT_ID, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This returns ExternalTask.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ExternalTask"));
	}
	...
	public String getText(Object object) {
		String label = ((ExternalTask) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_ExternalTask_type")
				: getString("_UI_ExternalTask_type") + " " + label;
	}
